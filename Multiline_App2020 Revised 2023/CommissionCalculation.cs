...

{
    ...
    public partial class CommissionCalculation : Form
    {
        public static String RptType4 = "";
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(cs))
                {
                    ...
                    conn.Open();
                    SqlCommand cmd = new SqlCommand("sp_CommissionCalculation", conn);
            ...
            RptType4 = "CommissionCalculation";
            status = "CommissionCal";
            OutputReport fmCommissionCalculation = new OutputReport();
