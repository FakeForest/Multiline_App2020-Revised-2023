...
namespace Multiline_App2020_Revised_2023
{
    public partial class SalesBilling : Form
    {
        ...
        {
            radioSalesId.Checked = true;
            radioCustAll.Checked = true;
        }
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            //case #1 - Billing for all sales reps and all customers

            if (radioSalesAll.Checked == true && radioCustAll.Checked == true)

            {
                ...
                try
                {
                    using (SqlConnection conn = new SqlConnection(cs))
                    {
                        ...
                        //calling stored procedure sp_BillingAllSalesAllCust in Multiline_db
                        conn.Open();
                        SqlCommand cmd = new SqlCommand("sp_BillingAllSalesAllCust", conn);
                ...
                RptType3 = "AllSalesAllCust";
                status = "SalesBiling";
                OutputReport fmBillingAllSalesAllCust = new OutputReport();
                fmBillingAllSalesAllCust.ShowDialog();
                status = "";
                //this.Hide();
                return;
            ...
            //case #2 - Billing for all sales reps and one customer

            else if (radioSalesAll.Checked == true && radioCustId.Checked == true)

            {
                ...
                try
                {
                    using (SqlConnection conn = new SqlConnection(cs))
                    {
                        ...
                        //calling stored procedure sp_BillingAllSalesAllCust in Multiline_db
                        conn.Open();
                        SqlCommand cmd = new SqlCommand("sp_BillingAllSalesPerCust", conn);
                ...
                RptType3 = "AllSalesPerCust";
                status = "SalesBiling";
                OutputReport fmBillingAllSalesPerCust = new OutputReport();
                fmBillingAllSalesPerCust.ShowDialog();
                status = "";
                //this.Hide();
                return;
            ...
            //case #3 - Billing for one sales rep and all customer

            else if (radioSalesId.Checked == true && radioCustAll.Checked == true)

            {
                ...
                try
                {
                    using (SqlConnection conn = new SqlConnection(cs))
                    {
                        ...
                        //calling stored procedure sp_BillingAllSalesAllCust in Multiline_db
                        conn.Open();
                        SqlCommand cmd = new SqlCommand("sp_BillingPerSalesAllCust", conn);
                ...
                RptType3 = "PerSalesAllCust";
                status = "SalesBiling";
                OutputReport fmBillingPerSalesAllCust = new OutputReport();
                fmBillingPerSalesAllCust.ShowDialog();
                status = "";
                //this.Hide();
                return;
            ...
            //case #4 - Billing for one sales rep and one customer

            else if (radioSalesId.Checked == true && radioCustId.Checked == true)
...

            {
                ...
                try
                {
                    using (SqlConnection conn = new SqlConnection(cs))
                    {
                        ...
                        //calling stored procedure sp_BillingAllSalesAllCust in Multiline_db
                        conn.Open();
                        SqlCommand cmd = new SqlCommand("sp_BillingPerSalesPerCust", conn);
                ...
                RptType3 = "PerSalesPerCust";
                status = "SalesBiling";
                OutputReport fmBillingPerSalesPerCust = new OutputReport();
                fmBillingPerSalesPerCust.ShowDialog();
                status = "";
                //this.Hide();
                return;
        ...
        private void radioSalesAll_CheckedChanged(object sender, EventArgs e)
        {
            if (radioSalesAll.Checked == true)
            {
                txtSalesId.Text = "";
        ...
        private void radioSalesId_CheckedChanged(object sender, EventArgs e)
        {
